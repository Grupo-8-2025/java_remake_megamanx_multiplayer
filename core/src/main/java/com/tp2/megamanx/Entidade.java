...
public class Entidade {
	...
	public Sprite getCorpo() { return corpo; }

	public int getRegionX() { return region.getRegionX(); }

	public int getRegionY() { return region.getRegionY(); }

	public int getRegionWidth() { return region.getRegionWidth(); }

	public int getRegionHeight() { return region.getRegionHeight(); }

	public boolean isParaDireita() { return paraDireita; }
